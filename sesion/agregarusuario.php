			 ...
			 WHERE CORREO='$correo' AND USUARIO='$usuario'")or die(mysql_error());
				...
				if ($resultado==1) {
					echo "EL usuario o correo ya estan registrados";
						...
						mysql_query("INSERT INTO REGISTRAR(NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO, USUARIO, IMAGEN, CORREO, CONTRASENA, FECHA, HORA)
							VALUES('$nombre','$apellido_p','$apellido_m','$usuario', 'images/default.png', '$correo','$contrasena','$fecha','$hora')",$conexion) or die(mysql_error());
